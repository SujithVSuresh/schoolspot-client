...
const AttendanceRecord = () => {
  ...
  <div className={`${student.status == "absent" ? "bg-red-100" : "bg-green-100"} rounded-xl p-4 relative`}>
  <div className="flex items-center justify-between">
    <div className="flex items-center gap-3">
      ...
      <div>
        ...
        <p className="text-xs sm:text-sm text-gray-500">Roll no: {student.rollNumber}</p>
      </div>
    </div>
    {/* Menu Button */}
    <button
