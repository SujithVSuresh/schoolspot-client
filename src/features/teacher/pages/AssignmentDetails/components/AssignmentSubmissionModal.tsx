...
export default function AssignmentSubmissionModal({ submission, isOpen, onClose, onSaveGrade }: AssignmentModalProps) {
    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4 z-50">
      <div className="bg-white rounded-lg shadow-xl w-full max-w-2xl relative">
        <div className="flex justify-between items-center p-6 border-b border-gray-200">
          <h2 className="text-xl font-semibold text-gray-800">{submission.student.fullName}</h2>
          <button
            onClick={onClose}
        ...
        >
          View Attached File
            ...
            <div className="space-y-4">
              ...
              <div>
                <h3 className="text-sm font-medium text-gray-500 mb-2">Grade (out of 10)</h3>
                <input
                  type="number"
                  min="0"
                  max="10"
