...
const AnnouncementCard = ({ announcement, classId, deleteAnnouncementHandler }: {announcement: AnnouncementType, classId: string, deleteAnnouncementHandler: (announcementId: string) => void}) => {
          ...
          <div className="relative">
            ...
            {showMenu == announcement._id && (
              <div className="absolute right-0 mt-2 w-48 rounded-md shadow-lg bg-white ring-1 ring-black ring-opacity-5">
                <div className="py-1">
                  <button onClick={() => navigate(`/teacher/classes/${classId}/announcements/${announcement._id}/update`)} className="flex items-center px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 w-full">
